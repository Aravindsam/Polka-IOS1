    ...
    if(hasCustomView) {
        ...
        switch (self.state) {
            case SVPullToRefreshStateStopped:
                ...
                [self setLastUpdatedDate:[[NSUserDefaults standardUserDefaults]objectForKey:@"LASTUPDATED"]];
...
//    DLog(@"%s",__func__);
   ...
   // [self.subtitles addObject:self.dateLabel.text];
}
